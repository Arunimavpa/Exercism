...
def check_drinks(drink_name, drink_ingredients):
    ...
    check=(ingredients.isdisjoint(ALCOHOLS))
    if check :
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category=[('VEGAN',VEGAN),
              ...
              ('KETO',KETO),
              ('OMNIVORE',OMNIVORE)]
    for name,ingredients in category:
...
def tag_special_ingredients(dish):
    ...
    special_ingred=ingred.intersection(SPECIAL_INGREDIENTS)
    return (dish_name,special_ingred)
...
def separate_appetizers(dishes, appetizers):
    ...
    new_list=dishes.difference(appetizers)
